...
//LOOP1:
 ...
 //LCD_INIT:
 	...
 	//wait 15ms
       ...
       18: oInstruction = {`NOP, 24'd0};//wait 15ms
       19: oInstruction = {`SHL, `R0, `R0, 8'd4};
       20: oInstruction = {`NOP, 24'd0};//wait 15ms
       ...
       26: oInstruction = {`NOP, 24'd205000 };//wait 4.1ms
       ...
       32: oInstruction = {`NOP, 24'd5000 };//wait 100us
